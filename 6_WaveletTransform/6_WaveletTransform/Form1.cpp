...
System::Void Form1::getWaveletToolStripMenuItem_Click(System::Object^  sender, System::EventArgs^  e){
	if (myWavelet != nullptr){
		delete myWavelet;
	}
	myWavelet = gcnew Wavelet();
	pictureBox2->Image = myWavelet->getWaveletResult(openFileDialog1->FileName);
}